          ...
          {[1, 2, 3].map((s) => (
            <div
              ...
              style={{
                height: "2px",
                flex: 1,
                background: s === 1 ? "#C9956C" : "rgba(255,255,255,0.1)",
                borderRadius: "2px",
              }}
            />
          ))}
        ...
        <div style={{ marginBottom: "2.5rem" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem" }}>
            {MOODS.map((mood) => (
              ...
              >
                <span style={{ color: mood.color, fontSize: "14px" }}>
                  {mood.icon}
                </span>
